  ...
  <b-navbar toggleable="lg" type="light"  variant="faded">
    ...
    <b-collapse id="nav-collapse" is-nav>
      ...
      <b-navbar-nav class="ml-auto ">
        ...
        <b-nav-item href="#" right><notification-bell iconColor='#007bff' /></b-nav-item>
       <p class="BD "> <em>Bonjour <br> Devinweb</em></p>
        <b-nav-item-dropdown right   aria-role="dialog"  >
          ...
          <b-dropdown-item  custom aria-role="menuitem"  href="#">
                <nuxt-link data-control-name="view_profile" to="/Espace-Recruteur" class="view-profile-Devinweb">      
          ...
          <b-dropdown-item has-link aria-role="menuitem">
                         <span  class="p-icon">
                            <nuxt-link type="" class="btn-floating-rec btn-briefcase pr-2 " to="/Espace-Recruteur/:MissionDeRecrutement">
          ...
          <b-dropdown-item value="Changer-le-mot-de-passe" aria-role="menuitem">
                        <span class="p-icon" >
                          <a type="" class="btn-floating-rec btn-edit pr-2 " @click="show=true" href="#">
